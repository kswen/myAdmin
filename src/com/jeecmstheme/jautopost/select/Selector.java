package com.jeecmstheme.jautopost.select;
 ...
 * <tr><td><code>:contains(<em>text</em>)</code></td><td>elements that contains the specified text. The search is case insensitive. The text may appear in the found element, or any of its descendants.</td><td><code>p:contains(jautopost)</code> finds p elements containing the text "jautopost".</td></tr>
 * <tr><td><code>:matches(<em>regex</em>)</code></td><td>elements whose text matches the specified regular expression. The text may appear in the found element, or any of its descendants.</td><td><code>td:matches(\\d+)</code> finds table cells containing digits. <code>div:matches((?i)login)</code> finds divs containing the text, case insensitively.</td></tr>
 * <tr><td><code>:containsOwn(<em>text</em>)</code></td><td>elements that directly contain the specified text. The search is case insensitive. The text must appear in the found element, not any of its descendants.</td><td><code>p:containsOwn(jautopost)</code> finds p elements with own text "jautopost".</td></tr>
...
public class Selector {
    ...
    public static class SelectorParseException extends IllegalStateException {
		...
		private static final long serialVersionUID = 1089170672343560409L;
