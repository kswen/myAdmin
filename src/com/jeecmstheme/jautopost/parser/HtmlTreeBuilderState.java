...
import com.jeecmstheme.jautopost.helper.DescendableLinkedList;
            ...
            switch (t.type) {
                ...
                case StartTag:
                    ...
                    if (name.equals("html")) {
                        ...
                        // jautopost special: update base the frist time it is seen
                        ...
                        // else if noscript && scripting flag = true: rawtext (jautopost doesn't run script, to handle as noscript)
                        tb.insert(start);
