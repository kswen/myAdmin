...
/**
 * This is an object that contains data related to the jc_jautopost_temp table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 *
 * @hibernate.class
 *  table="jc_jautopost_temp"
 */

public abstract class BaseCmsJautopostTemp  implements Serializable {

	private static final long serialVersionUID = -3319382163590166217L;
	public static String REF = "CmsJautopostTemp";
	 ...
	 */
	public BaseCmsJautopostTemp (java.lang.Integer id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof CmsJautopostTemp)) return false;
		else {
			CmsJautopostTemp cmsJautopostTemp = (CmsJautopostTemp) obj;
			if (null == this.getId() || null == cmsJautopostTemp.getId()) return false;
			else return (this.getId().equals(cmsJautopostTemp.getId()));
		}
	}
